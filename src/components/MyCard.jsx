...
const CustomCard = ({ isHomePageLookLike = false, isBlogPage = false }) => {
  const cardClassName = isHomePageLookLike ? "max-w-sm flex-shrink-0" : "w-5/6 mx-auto my-10";
  ...
  return (
    <div className="card-container">
      <Card
        ...
        imgSrc={temp}
      >
        <p className="text-left pl-4">avtori guja</p>
      ...
      {isBlogPage && (
        <div className="w-10/12 mx-auto ">
          <span className="">
            "aq mtliani agwera --- ragaca Lorem ipsum dolor sit amet consectetur
            adipisicing elit. Placeat eveniet mollitia temporibus vitae iure
            totam aliquam dolorem, tenetur illum quam sint nobis, soluta fugiat
            officiis? Atque omnis maiores reiciendis nihil!"
          </span>
        </div>
      )}
    </div>

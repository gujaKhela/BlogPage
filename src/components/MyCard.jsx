          ...
          {isBlogPage && (
            <div className="w-10/12 mx-auto ">
              <span className="">
                ...
                consectetur adipisicing elit. Placeat eveniet mollitia
                temporibus vitae iure totam aliquam dolorem, tenetur illum quam
                sint nobis, soluta fugiat officiis? Atque omnis maiores
                reiciendis nihil!"
              </span>
            </div>
          )}
